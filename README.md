...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0a3228e8-8d90-4c5d-9923-bb8e2fcb6f80
```

> `0a3228e8-8d90-4c5d-9923-bb8e2fcb6f80` is the password of the certificate, you can change it to any password you want.
