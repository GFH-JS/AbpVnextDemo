...
[DependsOn(
    ...
    typeof(BookStoreMongoModule),
    typeof(BookStoreRedisModule),
...
public class BookStoreWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "0a3228e8-8d90-4c5d-9923-bb8e2fcb6f80");
